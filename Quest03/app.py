...
menor_valor = min([dado["valor"] for dado in dados if dado["valor"] > 0])
maior_valor = max([dado["valor"] for dado in dados if dado["valor"] > 0])
...
print("Maior valor de faturamento: {:.2f}".format(maior_valor))
